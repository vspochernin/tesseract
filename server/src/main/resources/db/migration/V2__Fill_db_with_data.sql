...
INSERT INTO risks(description)
  VALUES('Среднерискованная. С преобладающим количеством активов, имеющих средний риск');
  
INSERT INTO risks(description)
  VALUES('Низкорискованная. С преобладающим количеством активов, имеющих низкий риск');
...
INSERT INTO users(login, email, password)
  VALUES('vspochernin', 'vspochernin@mail.ru', '$2y$10$8WnYPMm1M.2QihJm.08GsegoUqBwofBTeqmXOmNe0QiuqeHzKdXWm');

--полный (будет две диверсификации + четыре избранных)
INSERT INTO users(login, email, password)
  VALUES('vrazukrantov', 'vrazbusiness@mail.ru', '$2y$10$eMrHYk1VlK6M0suqWejbKOAHQKkGi5WMokuWeE6Qw9IfKZfeDRk8i');
