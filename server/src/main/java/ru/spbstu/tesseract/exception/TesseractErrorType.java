...
public enum TesseractErrorType {
    ...
    TOO_BIG_AMOUNT(10, "Запрашиваемая стоимость портфеля превысила 10_000_000 рублей", HttpStatus.BAD_REQUEST),
    ...
    TOO_LITTLE_AMOUNT(
            12,
            "Запрашиваемая стоимость портфеля меньше минимальной стоимости актива выбранной рискованности",
