...
\begin{longtable}{| p{0.35\textwidth} | p{0.65\textwidth} |}
    ...
    F\_DiversificationCreatePage\_1 & Страница создания диверсификации содержит в себе кнопки Назад, Создать диверсификацию, поле Сумма, Степень рискованности.                                                          \\ \hline
...
\begin{longtable}{| p{0.35\textwidth} | p{0.65\textwidth} |}
    ...
    F\_DiversificationPage\_1       & Страница диверсификации содержит в себе кнопку Назад, а также полную информацию о диверсификации (Сумму, Степень рискованности, список всех цифровых активов диверсификации).      \\ \hline
...
\begin{longtable}{| p{0.35\textwidth} | p{0.65\textwidth} |}
    ...
    F\_SettingsPage\_1              & Экран настроек содержит в себе кнопки Назад, Изменить пароль, Переключить тему, поля Cтарый пароль, Новый пароль, Подтверждение нового пароля, Выйти из аккаунта.                  \\ \hline
    F\_SettingsPage\_2              & При нажатии на кнопку Назад будет открыт предыдущий экран.                                                                                                                         \\ \hline
    F\_SettingsPage\_3              & Кнопка изменить пароль неактивна, если хотя бы одно из полей Старый пароль, Новый пароль, Подтверждение нового пароля пустое, а также если пользователь вошел через Google.        \\ \hline
    ...
    F\_SettingsPage\_7              & При нажатии на кнопку выйти из аккаунта происходи выход из аккаунта и переход на страницу входа.                                                                                   \\ \hline
